...
vh_get = function(resource = "optimized_route", from, to, costing = "auto", url = "http://localhost:8002/", ...) {
...
```{r}
route_example = vh_get(from = andorra_la_vella, to = pas_de_la_casa)
# str(route_example)
```
...
```{r}
route_example_bike = vh_get(from = andorra_la_vella, to = pas_de_la_casa, costing = "bicycle")
...
```{r}
route_example_bike_roads = vh_get(from = andorra_la_vella, to = pas_de_la_casa, costing = "bicycle", costing_options = list(bicycle= list(use_roads = 0.1)))
